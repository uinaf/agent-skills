...
Align the test setup with the toolchain. Do not rewrite the tests. Change only import sources, test runner scripts, and coverage configuration. Note any apparent problems that are valid under the new setup.
